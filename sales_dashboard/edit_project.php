                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <select name="c_name" id="c_name">
                            <option><?php if($rows['C_Name']!=''){ echo stripslashes($rows['C_Name']); }?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <select name="p_category" id="p_category">
                            < <option value=""><?php if($rows['Type']!=''){ echo stripslashes($rows['Type']); }?></option>
                    <?php 
                     ...
                     <!-- <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Assign Domain</label>
                        <div class="col-sm-7 controls">
                          <select name="p_designation" id="p_designation">
                            <option><?php if($rows['designation']!=''){ echo stripslashes($rows['designation']); }?></option>
