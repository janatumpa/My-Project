              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/p_edit_code.php" role="form">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                           <input type="text" name="s_position" id="s_position" value="<?php if($FetchRows['Position']!=''){ echo stripslashes($FetchRows['Position']); }?>" placeholder="Position">
                          </div>
                      </div>
