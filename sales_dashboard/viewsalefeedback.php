...
// }
// $uid = $_REQUEST["id"];  
$sql="SELECT * from pro_sales_feedback where id='".$_REQUEST["id"]."'";
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Client Details </h3>
                  </div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/client_code_add.php" role="form">
                   
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Name</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['Name']; ?>" readonly="readonly"/> 
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Team Player</label>
                        <div class="col-sm-7 controls">
                           <input type="text" value="<?php echo $fetch['Team_Player']; ?>" readonly="readonly"/>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $fetch['Ownership']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Quick Learner</label>
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $fetch['Quick_Learner']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Problem Solver</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['Problem_Solver']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Passionate</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['Passionate']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Proactive</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['proactive']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <!--<div class="form-group">
                        <label class="col-sm-4 control-label">Proactive</label>
                      ...
                      <!--</div>-->
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Hard Working</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['Hardworking']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Attitude</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['Attitude']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                        <?php
                        $sum=$fetch['Team_Player']+$fetch['Ownership']+$fetch['Quick_Learner']+ $fetch['Problem_Solver']+$fetch['Passionate']+$fetch['proactive']+$fetch['Hardworking']+$fetch['Attitude'];
                    ?>
                     <input type="text" value="<?php echo $sum; ?>" readonly="readonly"/>
                        </div>
                      </div>
                   </form>
                  </div>
