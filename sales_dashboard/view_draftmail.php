...
if($_SESSION['userid'] == "" && $_SESSION['loggedIn'] == ""){
    ...
    {
		$D_id = mysql_real_escape_string($_GET['D_Id']);
		$D_id = intval($D_id);
		$d_record = mysql_query("select * from pro_draft where Draft_Id='$D_id'");
                ...
                <div class="panel widget light-widget">
                  ...
                  <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" action="Code/mail_code.php" method="post">
                        <input type="hidden" name="id" value="<?=$_REQUEST['D_Id']?>">
                      <div class="form-group clearfix">
                        <label class="col-sm-2 control-label">To</label>
                        <div class="col-sm-10 controls">
                          <input id="email-input" type="text" name="to" class="input-border-btm" value="<?php echo $rows[Email_Id]?>">
                        </div>
                      </div>
                      <div class="form-group  clearfix">
                        <label class="col-sm-2 control-label">Subject</label>
                        <div class="col-sm-10 controls">
                          <input type="text" id="subject" name="subject" class="input-border-btm" placeholder="Subject Title" value="<?php echo $rows[Subject]?>">
                        </div>
                      </div>
                      <br/>
                      ...
                      <div class="form-group  clearfix">
                        ...
                        <div class="col-sm-12 controls">
                          <textarea id="message" name="message" class="width-100 form-control"  rows="15" placeholder="Write your message here"><?php echo $rows[Message]?></textarea>
                        </div>
                      </div>
                    ...
                    <form class="form-horizontal" role="form" action="Code/mail_code.php">
                          ...
                          <div class="form-group clearfix" style="height: 250px; overflow-y:scroll;">
                              <div class="col-md-12">
                                 <?php
                                 $c=1;
                                    $SqlUser = "SELECT Dev_Name as name,Email_Id as email,Designation as deg FROM pro_dev_registration union SELECT Sale_Name as name,EmailId as email,Position as deg FROM pro_sale_registration WHERE S_id != '".$_SESSION['userid']."'";
                                ...
                                <div class="content-list content-menu" id="email-list">
                                  <div class="list-wrapper wrap-25 isotope">
                                    ...
                                    <input type="checkbox" class="mail" onclick="addMail();" id="<?php echo $c ?>" value="<?php echo $FetchRows['email']; ?>">
                                    <label class="filter-name" for="<?php echo $c ?>"> <?php echo $FetchRows['name']; ?> (<?php echo $FetchRows['deg']; ?>) <em class="font-normal"><?php echo $FetchRows['email']; ?></em> </label>
