...
$d=$days/30;
   ...
   ?>
            ...
            <a href="saleave.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-plus append-icon"></i> Approve </a>
                    <?php
                }
                ?>
                      ...
                      <?php
                        $rows_per_page=12;
                         if(isset($_REQUEST['page']))
                          ...
                          $res_product=mysql_query("SELECT * from pro_sale_registration WHERE S_id = '".$_SESSION['userid']."'");
                          $totnumrow=mysql_num_rows($res_product);
                          $totrow=ceil($totnumrow/$rows_per_page);
                            
                            $subCatSql="SELECT * from pro_sale_registration WHERE S_id = '".$_SESSION['userid']."' limit $offset,$rows_per_page ";
                          $ResSqlUser=mysql_query($subCatSql) or mysql_error();
                          
                     
                 $c = 1;
                 $SqlUser = "SELECT * FROM pro_sale_leaveapp WHERE userid ='" . $_SESSION['userid'] . "'";
