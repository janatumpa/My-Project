...
session_start();
    ...
    {
		$Client_id = mysql_real_escape_string($_GET['C_ID']);
		$Client_id = intval($Client_id);
		$c_record = mysql_query("select * from pro_customer where C_id='$Client_id'");
	}
?>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Edit Client Details </h3>
                  </div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/client_code_edit.php" role="form">
                    <?php
                      if(mysql_num_rows($c_record) > 0)
                      {
	                  while($rows = mysql_fetch_array($c_record))
                      {
                    ?>
                    <input type="hidden" name="cid" id="cid" value="<?php echo $rows['C_id']; ?>" />
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="name" id="name" value="<?php if($rows['Name']!=''){ echo stripslashes($rows['Name']); }?>">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Company Name</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_name" id="c_name" value="<?php if($rows['Company']!=''){ echo stripslashes($rows['Company']); }?>">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_location" id="c_location" value="<?php if($rows['Location']!=''){ echo stripslashes($rows['Location']); }?>">
                          </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_phn" id="c_phn" value="<?php if($rows['Phone']!=''){ echo stripslashes($rows['Phone']); }?>">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                         <input type="text" name="c_email" id="c_email" value="<?php if($rows['Email']!=''){ echo stripslashes($rows['Email']); }?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Nature of business</label>
                        <div class="col-sm-7 controls">
                         <input type="text" name="c_business" id="c_business" value="<?php if($rows['Nature_of_business']!=''){ echo stripslashes($rows['Nature_of_business']); }?>">
                        </div>
                      </div>
                      <div class="form-group form-actions">
                        ...
                        <div class="col-sm-7">
                          ...
                          <a class="btn vd_btn" href="client_list.php">Cancel</a>
                        </div>
                      </div>
                      <?php
	                    }
