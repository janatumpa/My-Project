...
// }
// $uid = $_REQUEST["id"];  
$sql="SELECT * from pro_sales_timesheet where id='".$_REQUEST["id"]."'";
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="view_six.php">ViewSixMonth List</a> </li>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Details</h3>
                  </div>
