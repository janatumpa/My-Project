	...
	<body>
		<section class="con1 height114 heightresback " id="marginbottom20">
			...
			<div class="cardhome1 heightres">
				...
				<form name="reg" method="post" onSubmit="return new_d()" id="paddingtop3">
					...
					<div class="md-form">
					   ...
					   border: none;
					   color: #757575;
					   font-size: 1rem;" onChange="myFunction(this.value);" >
                       <option value="0">Role</option>
					    <option value="Vertical lead">Vertical Head</option>
					   <option value="Manager">Manager</option>
					   <option value="Developer">Developer</option>
			            </select>
						<div class="md-form" id="manager" style="
				        display:none;
				         width: 100%;
					   padding: 15px;
					   border-bottom:1px solid #ccc !important;
			...
			<?php
                        ...
                        $SqlUser = "SELECT * FROM  pro_dev_registration WHERE Role='Vertical lead' ";
