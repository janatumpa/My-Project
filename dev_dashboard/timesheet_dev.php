 ...
 ?>
   ...
   <div class="vd_content-wrapper">
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
          ...
          <div class="vd_content-section clearfix">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                ?>
                      <a href="Viewmanager.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-eye append-icon"></i> View  Reportee List </a> 
                <?php }
                ?>
                    <a href="view_six.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-eye append-icon"></i> View Six Months List </a> 
                     <a href="add_timesheet.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-plus append-icon"></i> Add  Timesheet </a>
				...
				<h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-table"></i>Timesheet </h3>
                  ...
                  $c = 1;
                 $SqlUser = "SELECT * FROM pro_devs_timesheet WHERE Date > DATE_ADD( CURDATE(), INTERVAL -5 DAY ) and userid = '".$_SESSION['userid']."'";
      ...
      <td><b><a href="view_timesheet.php?id=<?php echo $FetchRows['id']?>"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></b></a></td>
        <td><b><a href="edit_timesheet.php?Id=<?php echo $FetchRows['id']?>"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></b></a></td>
