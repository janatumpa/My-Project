...
if(isset($_POST['submit']))
{
    ...
    $sql="INSERT INTO pro_dev_leaveapp SET 
        name='".$_POST['name']."',
        userid='".$_POST['userid']."',
        from_date='".$FROM."',
        to_date='".$TO."',
                    ...
                    <form method="post" class="form-horizontal" action="" role="form">
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="name" readonly value="<?php echo $FetchRows['Dev_Name']; ?>" />
                          </div>
                      </div>
                      <div class="form-group">
                        
                        
                          <input type="hidden" name="userid" readonly value="<?php echo $FetchRows['D_id']; ?>" />
