...
include "lib/sidebar.php";
 ?>
			...
			<!--	<div class="vd_info tr"> <a href="add_project.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-plus append-icon"></i> Add Project </a> </div>     -->    
				...
				<table id="data-tables" class="table table-striped table-hover">
                 ...
                 <?php
                  ...
                  $fetch = mysql_fetch_array($ResSqlUser);



               //$count = mysql_num_rows($ResSqlUser);
              
              if($fetch['Role'] == 'vertical_head'){
                $sam = "SELECT * FROM pro_project WHERE designation='".$fetch['designation']."'";
              }elseif($fetch['Role'] == 'manager'){
                 $sam = "SELECT * FROM pro_project WHERE D_id='".$_SESSION['userid']."'"; 
               }elseif($fetch['Role'] == 'developer'){
                 ...
                 // $SqlUser2 = "SELECT * FROM pro_project WHERE Role ='".$FetchRows['Role']."' AND designation ='".$FetchRows['designation']."'";
  ...
  // $sam= "SELECT D_id FROM pro_dev_registration  INNER JOIN pro_project ON  pro_project.designation =pro_dev_registration.'".$FetchRows['designation']."'";   
       ...
       while( $FetchRows2 = mysql_fetch_array($ResSqlUser2))
          {
             ?>            
                    ...
                    <td class="menu-action rounded-btn" width="15%" >
                                       <a href="assignviewdev.php?projectid=<?php echo $FetchRows2['P_id']; ?>" class="btn menu-icon vd_bg-green" data-placement="top" data-toggle="tooltip" data-original-title="view">
                                            <i class="fa fa-eye"></i>
                                          </a>                                      
                                        <!--<a href="edit_projectdev.php?P_ID=<?php echo $FetchRows2['P_id']; ?>"class="btn menu-icon vd_bg-yellow" data-placement="top" data-toggle="tooltip" data-original-title="edit">-->
                                            <!--<i class="fa fa-pencil"></i>-->
                                          <!--</a>-->
                                      
                                        <a href="delete/delproject.php?id=<?php echo $FetchRows2['P_id']; ?>" onClick="javascript:return confirm('Are You Sure?');" class="btn menu-icon vd_bg-red" data-placement="top" data-toggle="tooltip" data-original-title="delete">
                                            <i class="fa fa-times"></i>
                                          </a>
                                        <?php if($fetch['Role']!="manager" && $fetch['Role']!="developer")
                                         {
                                          ?>
                                      ...
                                      else if($fetch['Role']!="vertical_head" && $fetch['Role']!="developer"){          
                                         ?> 
