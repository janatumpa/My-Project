...
// }
// $uid = $_REQUEST["id"];  
$sql="SELECT * from pro_devs_timesheet where id='".$_REQUEST["id"]."'";
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
               ...
               <li><a href="viewmanager.php"> Reportee List</a> </li>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Reportee Timesheet </h3>
                  </div>
                    ...
                    <form method="post" class="form-horizontal" action="Code/client_code_add.php" role="form">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['projectname']; ?>" readonly="readonly"/> 
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Task</label>
                        <div class="col-sm-7 controls">
                           <input type="text" value="<?php echo $fetch['task']; ?>" readonly="readonly"/>
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Date</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $fetch['Date']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $fetch['start']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">End Time</label>
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $fetch['end']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Total Time</label>
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $fetch['total']; ?>" readonly="readonly"/>
                        </div>
                      </div>
