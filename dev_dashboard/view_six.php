              ...
              <ul class="breadcrumb">
                <li><a href="index.php">Home</a> </li>
                  <li><a href="timesheet_dev.php">Timesheetlist</a> </li>
                   <li><a href="">VeiwSixMonth List</a> </li>
            ...
            <div class="row">
              <div class="col-md-12">
				...
				<h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-table"></i>Timesheet </h3>
                 ...
                 $c = 1;
                 $SqlUser = "SELECT * FROM pro_devs_timesheet WHERE Date >  DATE_SUB(now(), INTERVAL 6 MONTH) and userid = '".$_SESSION['userid']."'";
               ...
               ?>
                 ...
                 <td><?php echo $FetchRows['total']; ?></td>
                  ...
                  <td><b><a href="view_timesheet.php?id=<?php echo $FetchRows['id']?>"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></b></a> 
</td>                                    
									 </td> 
