	...
	include"config/connect.php";
		...
		if($_POST['submit']=="Log In") {
			...
			$d_password = $_POST['pwd'];
					...
					$FetchUserSql = "SELECT * FROM pro_sale_registration WHERE EmailId = '".$d_email."' AND Password = '".base64_encode($d_password)."' AND SaleStatus = 'Yes' AND EmailVerification = 'Yes'";
					...
					$_SESSION['userid'] = $FetchRows['S_id'];
					$_SESSION['loggedIn'] = $FetchRows['EmailId'];
					...
					if($_REQUEST['rem'] == 'yes')
					{
						...
						header("location:sales_dashboard/index.php?login=successful");
				} else {
					header("location:s_login.php?login=fail");
		...
		<section class="con1">
			...
			<div class="cardhome11 ">
				...
				<div class="login">
					...
					<h2 class="title-text"><span class="txtclr1">Log In As Sales</span></h2>
