	 ...
	 if($_POST['submit']=="SUBMIT") 
     {
		       ...
		       $InsertRegSql="INSERT INTO pro_dev_registration SET 
					   ...
					   mysql_query($InsertRegSql) or die(mysql_error());
						...
						echo 'window.location="d_reg.php?mess=successful"';
						echo '</script>';
						
						} else{
								echo '<script language="javascript">';
								echo 'window.location="d_reg.php?mess=registrationunsuccessful"';
								echo '</script>';
							  }
	...
	<body>
		<section class="con1 height114 heightresback " id="marginbottom20">
			...
			<div class="cardhome1 heightres">
				...
				<form name="reg" method="post" onSubmit="return new_d()" id="paddingtop3">
					...
					<div class="md-form">
                   	...
                   	<select name="d_role" id="d_role"  onChange="myFunction(this.value);"  class="selectborder">
			...
			<?php
					...
					<select name="d_designation" id="d_designation" class="selectborder">
					...
					<div class="md-form">
						<input type="text" name="d_doj" id="datepicker"required />
