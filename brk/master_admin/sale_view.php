            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="panel widget light-widget">
                  ...
                  <form method="post" name="proedit" class="form-horizontal" action="" role="form" onSubmit="return profilepwdvalid()">
                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                          <input type="text" name="s_username" id="s_username" value="<?php echo $rows['S_Username']?>" placeholder="User Name" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="eid" id="eid" value="<?php echo $rows['Sale_id']; ?>" placeholder="Name" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="s_name" id="s_name" value="<?php echo $rows['Sale_Name'];?>" placeholder="Name" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                           <input type="text" name="s_add" id="s_add" value="<?php echo $rows['S_address'];?>" placeholder="Address" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                           <input type="text" name="s_state" id="s_state" value="<?php echo $rows['S_State'];?>" placeholder="State" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="text" name="s_zip" id="s_zip" value="<?php echo $rows['S_Zip'];?>" placeholder="Zip" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                              </div>
                              <!-- row --> 
                              ...
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <span class="vd_radio radio-info">
                                    <input type="radio" value="male" id="optionsRadios3" name="d_gen"  <?php if($rows['S_Gen']=="male") {?> checked="checked" <?php }?>>
                                    <label for="optionsRadios3"> Male </label>
                                  </span>
                                  <span class="vd_radio  radio-danger" > 
                                    <input type="radio" value="female" id="optionsRadios4" name="d_gen" <?php if($rows['S_Gen']=="female") {?> checked="checked" <?php }?>>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="text" name="S_Marital" id="S_Marital" value="<?php echo $rows['S _Marital'];?>" placeholder="Marital" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="s_role" id="s_role" value="<?php echo $rows['Role'];?>" placeholder="Designation" disabled>
                                </div>
                                <!-- col-xs-12 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                         <input type="text"  name="s_phn" id="s_phn" value="<?php echo $rows['PhoneNo'];?>" placeholder="Phone No" disabled >
                                </div>
                                <!-- col-xs-12 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text"  name="s_li" id="s_li" value="<?php echo $rows['S_LI'];?>" placeholder="LinkedIn" disabled>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                   <input type="text"  name="s_fb" id="s_fb" value="<?php echo $rows['S_FB'];?>" placeholder="Facebook" disabled>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text"  name="s_tw" id="s_tw" value="<?php echo $rows['S_TW'];?>" placeholder="Twitter" disabled>
                                </div>
                                <!-- col-xs-9 -->
