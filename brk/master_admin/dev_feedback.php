...
include "lib/sidebar.php";
 ?>
  ...
  <ul class="nav nav-tabs widget">
    ...
    <li class="active"> <a data-toggle="tab" href="#projects-tab"> Developer <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>   
  ...
  <div class="tab-content">
    ...
    <div id="projects-tab"  class="tab-pane active">
    	<div class="pd-20">
              ...
              <?php
                 $c = 1;
                 $SqlUser = "SELECT * FROM ".TABLE_PREFIX."dev_registration";
               ...
               ?>
                  ...
                  <td><?php echo $c ?></td>              	
									...
									<td class="menu-action rounded-btn" width="13%">
                                    	...
                                    	<a href="view_feedback.php?DF_ID=<?php echo $FetchRows['D_id']; ?>" class="btn menu-icon vd_bg-green" data-placement="top" data-toggle="tooltip" data-original-title="view">
                                           <i class="fa fa-eye"></i>
                                        </a>                                      
                                    	</td>
                   <td class="menu-action rounded-btn" width="13%">
                                    	<a href="viewfeedsales.php?DF_ID=<?php echo $FetchRows['D_id']; ?>" class="btn menu-icon vd_bg-green" data-placement="top" data-toggle="tooltip" data-original-title="view">
                                           <i class="fa fa-eye"></i>
                                        </a>                                      
                                     </td>
