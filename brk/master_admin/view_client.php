...
if($_SESSION['admin_id'] == "" && $_SESSION['admin_username'] == ""){
	...
	if(isset($_GET['C_ID']) && $_GET['C_ID'] != "")
    {
		...
		$c_record = mysql_query( "SELECT sr.*, pr.* FROM ".TABLE_PREFIX."customer as pr INNER JOIN pro_sale_registration as sr WHERE pr.S_id=sr.S_id AND C_id='".$Client_id."'");
                    ...
                    ?>
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Sale_Name']; ?>" readonly="readonly"/> 
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Company Name</label>
                        <div class="col-sm-7 controls">
                           <input type="text" value="<?php echo $rows['Company']; ?>" readonly="readonly"/>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $rows['Location']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Phone No</label>
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $rows['Phone']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Email Address</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Email']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Nature of business</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Nature_of_business']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Date & Time</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Date']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <?php
	                    }
