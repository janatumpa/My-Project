...
if($_SESSION['admin_id'] == "" && $_SESSION['admin_username'] == ""){
    ...
    {
		$feedback_id = mysql_real_escape_string($_GET['C_ID']);
	//	$feedback_id = intval($feedback_id);
		$c_record = mysql_query("select * from pro_sales_feedback where id='".$feedback_id."'");
    $rows = mysql_fetch_array($c_record);
	}
?>
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="sales_feedback.php">Sales Feedback List</a> </li>
                <li>View Feedback</li>
              </ul>
                    ...
                    <form method="post" class="form-horizontal"  role="form">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Name']; ?>" readonly="readonly"/> 
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Team Player</label>
                        <div class="col-sm-7 controls">
                           <input type="text" value="<?php echo $rows['Team_Player']; ?>" readonly="readonly"/>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $rows['Ownership']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Quick Learner</label>
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $rows['Quick_Learner']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Problem Solver</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Problem_Solver']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Passionate</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Passionate']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Proactive</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['proactive']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Hardworking</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Hardworking']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                  <div class="form-group">
                        <label class="col-sm-4 control-label">Attitude</label>
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Attitude']; ?>" readonly="readonly"/>
                        </div>
                      </div>
 <div class="form-group">
...
<?php
                $sum = $rows['Attitude']+$rows['Hardworking']+$rows['proactive']+$rows['Passionate']+$rows['Problem_Solver']+$rows['Quick_Learner']+$rows['Ownership']+$rows['Team_Player'];          
?>
