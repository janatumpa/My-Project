              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Sale </h3>
                  </div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/sale_code_add.php" role="form">
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Sale Name</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="s_name" id="s_name" placeholder="Enter Sale Name">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Employee Id</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="s_eid" id="s_eid" placeholder="Enter Sale Id">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Email Address</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="s_email" id="s_email" placeholder="Enter Email Address">
                          </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Phone No</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="s_phn" id="s_phn" placeholder="Enter Phone No">
                          </div>
                      </div>
                      <div class="form-group">
                        ...
                        <option value="Employee">Employee</option>
                          ...
                          <!--<input type="text" name="s_role" id="s_role" placeholder="Enter Role">-->
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Password</label>
                        <div class="col-sm-7 controls">
                          <input type="password" name="s_pwd" id="s_pwd" placeholder="Password">
                          </div>
                      </div>
