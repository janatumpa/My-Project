          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="timesheet_dev.php"> Timesheet List</a></li>
                <li>View Reportee List</li>
                </ul>
                ...
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    ...
                    <!--<a href="View_six.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-eye append-icon"></i> View Six Months List </a> -->
                     <a href="add_timesheet.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-plus append-icon"></i> Add  Timesheet </a> </div>         
                 ...
                 <td><?php echo $FetchRows['total']; ?></td>
                    <td><?php echo $FetchRows['Date']; ?></td>-->
									<td class="menu-action rounded-btn">
                                    	<td><b><a href="viewall.php?id=<?php echo $FetchRows['D_id']?>"<i class="fa fa-eye fa-2x" aria-hidden="true"></i></b></a> 
</td>                                    
									 </td> 
