...
//For Cover Image
                 if($FetchRows['D_image'] == "")
                    {
                    $pic = "profileimage/nopic.png";
                    }
                    else if(!is_file("profileimage/".$FetchRows['D_image']))
                    {
                    $pic = "profileimage/nopic.png";
                    }
                    else
                    {
                    $pic = "profileimage/".$FetchRows['D_image'];
                    }
?>
<!DOCTYPE html>
<html>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header no-subtitle">
              <h1>Welcome <?php echo $FetchRows['Dev_Name'];?></h1>
            </div>
          </div>
                             ...
                             <div>
                              ...
                              <div>
                                <table class="table table-striped">
                                  <tbody>
                                     <tr>
                                      <td><a href="<?php echo $FetchRows['D_FB'];?>" target="blank"><img src="img/facebook.png"/></a></td>
                                      <td><a href="<?php echo $FetchRows['D_LI'];?>" target="blank"><img src="img/linkedin.png"/></a></td>
                                      <td><a href="<?php echo $FetchRows['D_TW'];?>" target="blank"><img src="img/twitter.png"/></a></td>
                                    </tr>
                                  </tbody> 
                                </table>
                              </div>
        ...
        <div class="row">
          <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['Dev_Name'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['D_Username'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['Email_Id'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['Phone_No'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['D_address'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['D_State'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['D_Zip'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['designation'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
             <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['D_Gen'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="col-xs-7 controls"><?php echo $FetchRows['D_Marital'];?></div>
                <!-- col-sm-12 --> 
                </div>
            </div>
       </div><!--row end-->
