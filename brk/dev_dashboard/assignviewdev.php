...
if ($_SESSION['userid']=="" && $_SESSION['loggedIn']=="") { 
    ...
    {
		$Project_id = mysql_real_escape_string($_GET['projectid']);
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/project_codedev_add.php" role="form">
                    <?php
                    ...
                    ?>
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                         <input type="text" value="<?php echo $rows['Domain']; ?>" readonly="readonly"/> 
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $rows['Type']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Project Category</label>
                        <div class="col-sm-7 controls">
                          <input type="text" value="<?php echo $rows['Category']; ?>" readonly="readonly"/>
                        </div>
                      </div>
                      <div class="form-group">
                       ...
                       <a href="../Documents/<?=$image?>" download>Attachment <?php echo $cnt;?></a> <br>
