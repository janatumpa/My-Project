    ...
    <div id="projects-tab"  class="tab-pane active">
    	<div class="pd-20">
				...
				<table class="table table-striped table-hover">
                 ...
                 <?php
                $c = 1;
                 $SqlUser = "SELECT * FROM pro_project WHERE S_id = '".$_SESSION['userid']."' AND ProStatus='Yes'";
                ...
                ?>             
                  ...
                  <td> <?php echo $FetchRows['Name']; ?></td>                                    
                                    ...
                                    <select class="span9 chosen"  id="stat<?=$FetchRows['P_id']?>" onChange="changestatus(this.value,'<?=$FetchRows['P_id']?>')">
												<option value="true" <?=$FetchRows['ProStatus'] == 'Yes' ? 'selected' : ''?>>Active</option>
												<option value="false" <?=$FetchRows['ProStatus'] == 'No' ? 'selected' : ''?>>InActive</option>
											 </select>
                                    </td>
