...
<div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
  ...
  if($FetchRows['Role'] == 'vertical_head'){
             ...
             //  $FetchRows2 = mysql_fetch_array($ResSqlUser2);
                    ...
                    <td><?php echo $FetchRows2['Category']; ?></td>
                    <td><?php echo $Fetch['Sale_Name']; ?></td>  
                    <td>
                   <select class="span9 chosen"  id="stat<?=$FetchRows['P_id']?>" onChange="changestatus(this.value,'<?=$FetchRows['P_id']?>')">
									 <option value="working" <?=$FetchRows2['ProStatus'] == 'working' ? 'selected' : ''?>>Working</option>
									 <option value="complete" <?=$FetchRows2['ProStatus'] == 'complete' ? 'selected' : ''?>>Complete</option>
                   <option value="pending" <?=$FetchRows2['ProStatus'] == 'pending' ? 'selected' : ''?>>Pending</option>
									 <option value="live" <?=$FetchRows2['ProStatus'] == 'live' ? 'selected' : ''?>>Live</option>
									 </select>
                  </td>
                    <td class="menu-action rounded-btn">
                    <a href="view_project.php?projectid=<?php echo $FetchRows2['P_id']; ?>" class="btn menu-icon vd_bg-green" data-placement="top" data-toggle="tooltip" data-original-title="view">
                        <i class="fa fa-eye"></i>
                      </a>
                    <td class="menu-action">
                        <a href="#" class="btn menu-icon vd_bg-blue" data-toggle="modal" data-target="#myModal<?=$FetchRows2['P_id']?>"><i class="fa fa-clipboard"></i></a>
                        <a href="viewnotes.php?proid=<?=$FetchRows2['P_id']?>" class="btn menu-icon vd_bg-blue"><i class="fa fa-eye"></i></a>
                    </td> 
                     <td class="menu-action">
                     ...
                     <!-- Modal -->
                      <div class="modal fade" id="myModal<?=$FetchRows2['P_id']?>" role="dialog">
                     ...
                     <form class="form-horizontal" action="<?=$_SERVER['PHP_SELF']?>" method="post" role="form">
                       <input type="hidden" name="projectid" value="<?=$FetchRows2['P_id']?>">
