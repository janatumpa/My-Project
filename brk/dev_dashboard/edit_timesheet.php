...
if($_SESSION['admin_id'] == "" && $_SESSION['admin_username'] == ""){
   // header("location:index.php");
	...
	if(isset($_GET['Id']) && $_GET['Id'] != "")
    {
		...
		$s_record = mysql_query("select * from pro_devs_timesheet where id='$time_id'");
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="timesheet_dev.php">TimesheetList</a> </li>
                <li>Add Timesheet</li>
              </ul>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Timesheet </h3>
                  </div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/edit1_timesheet.php" role="form">
                        <!--<div class="form-group">
                        <label class="col-sm-4 control-label"> Name</label>
                        <div class="col-sm-7 controls">
                          <input value="<?php echo $FetchRows['Dev_Name']; ?>" name="projectname" id="projectname" readonly="readonly" >
                          </div>
                      </div>-->
               ...
               if($FetchRows['Role'] == 'vertical_head'){
                $sam = "SELECT * FROM pro_project WHERE designation='".$FetchRows['designation']."'";
               ...
               ?>
                        ...
                        <option value="<?php echo $FetchRows2['Name'];?>" <?php if($FetchRows2['Name']==$rows['projectname']){echo 'selected';}?>><?php echo $FetchRows2['Name'];?></option>                
             <?php
                 ...
                 ?>   
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="task" id="task"  value="<?php if($rows['task']!=''){ echo stripslashes($rows['task']); }?>" placeholder="Enter ">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Date</label>
                        <div class="col-sm-7 controls">
                          <input type="date" name="Date" id="Date" value="<?php if($rows['Date']!=''){ echo stripslashes($rows['Date']); }?>" placeholder="Y-m-d">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="start" id="start"  value="<?php if($rows['start']!=''){ echo stripslashes($rows['start']); }?>" placeholder="Ex:10:10 AM">
                          </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">End Time</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="end" id="end" value="<?php if($rows['end']!=''){ echo stripslashes($rows['end']); }?>" placeholder="Ex:11:45 AM">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Total</label>
                        <div class="col-sm-7 controls">
                        <input type="text"  name="diftime" id="diftime" value="<?php if($rows['total']!=''){ echo stripslashes($rows['total']); }?>" placeholder="total">
                        </div>
                      </div>
                      ...
                      <div class="form-group form-actions">
                        ...
                        <div class="col-sm-7">
                          ...
                          <a class="btn vd_btn" href="timesheet_dev.php">Cancel</a>
                        </div>
                      </div>
...
<script type="text/javascript">
	...
	var day = '1 1 1970 ',  // 1st January 1970
        diff_in_min = ( Date.parse(day + etime) - Date.parse(day + stime) ) / 1000 / 60;
		hr = Math.floor(diff_in_min / 60);
		min = diff_in_min % 60;
		if(min < 10){
			min = '0'+min;
		}
		//alert(hr + 'hrs '+ min +'Mins');
		$ ('#diftime').val(hr+':'+min);
