          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="viewmanager.php">Reportee List</li>
            ...
            <div class="row">
              <div class="col-md-12">
				...
				<h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-table"></i>Timesheet </h3>
                 ...
                 $c = 1;
          $SqlUser = "SELECT * FROM pro_devs_timesheet WHERE Date >  DATE_ADD( CURDATE(), INTERVAL -180 DAY ) and userid = '".$_REQUEST['id']."'"; 
                  ...
                  <td><?php echo $c ?></td>              	
                                   ...
                                   <td><?php echo $FetchRows['total']; ?></td>
									...
									<td class="menu-action rounded-btn">
                                    	<td><b><a href="vieweach.php?id=<?php echo $FetchRows['id']?>"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></b></a> 
</td>                                    
									 </td> 
