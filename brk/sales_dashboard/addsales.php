...
if($_POST['submit']=="SUBMIT")
{
 ...
 $insert=mysql_query("insert into pro_sales_feedback (Name,user_id,Team_player,Ownership,Quick_Learner,Problem_Solver,Passionate,proactive,Hardworking,Attitude) values('".$Name."','".$_SESSION['userid']."','".$Team_Player."','".$Ownership."','".$Quick_Learner."','".$Passionate."','".$Problem_Solver."','".$proactive."','".$Hardworking."','".$Attitude."')") or die(mysql_error());
   //exit();
   if($insert)
   {
    header("location: sales_feedback.php");
   }
   else
   {
...
<?php
  $SqlUser = "SELECT * FROM pro_sale_registration ";
                        ...
                        ?>    
                         <option ><?php echo $FetchRows['Sale_Name'];?></option> 
 <?php 
                        }
                        ?>                       
                         </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="Team_Player" id="Team_Player" placeholder="Enter">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="Ownership" id="Ownership" placeholder="Enter">
                          </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Quick Learner</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="Quick_Learner" id="Quick_Learner" placeholder="Enter">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Problem Solver</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="Problem_Solver" id="Problem_Solver" placeholder="Enter">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Passionate</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="Passionate" id="Passionate" placeholder="Enter">
                          </div>
                          </div>
                         <div class="form-group">
                        <label class="col-sm-4 control-label">Proactive</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="proactive" id="proactive" placeholder="Enter">
                          </div>
                          </div>
                          <div class="form-group">
                        <label class="col-sm-4 control-label">Hardworking</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="Hardworking" id="Hardworking" placeholder="Enter">
                          </div>
                          </div>
                           <div class="form-group">
                        <label class="col-sm-4 control-label">Attitude</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="Attitude" id="Attitude" placeholder="Enter ">
                          </div>
                      </div>
