          ...
          <div class="vd_content-section clearfix">
            ...
            <div class="row">
              <div class="col-md-12">
				...
				<h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-bolt mgr-10 profile-icon"></i> FEEDBACK<a href="addsales.php" class="btn vd_btn btn-xs vd_bg-yellow" style="float: right;"> <i class="fa fa-plus append-icon"></i> Add Feedback </a>  </h3>
                  </div>
                  <div class="panel-body  table-responsive">
                      ...
                      <tbody>
                       <?php
                        ...
                        if(isset($_REQUEST['page']))
                          ...
                          $res_product=mysql_query("select * from pro_sales_feedback WHERE user_id = '".$_SESSION['userid']."' limit $offset,$rows_per_page");
                        ...
                        $SqlUser = "SELECT * FROM pro_sales_feedback WHERE user_id = '".$_SESSION['userid']."'";
                        $ResSqlUser = mysql_query($SqlUser);
                   ...
                   <td><b><a href="viewsalefeedback.php?id=<?php echo $FetchRows['id']?>"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></b></a> 
</td>
