              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span> Project Edit </h3>
                  </div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/project_code_edit.php" role="form">
                    <?php
                      if(mysql_num_rows($p_record) > 0)
                      {
	                  while($rows = mysql_fetch_array($p_record))
                      {
                    ?>
                    <input type="hidden" name="pid" id="pid" value="<?php echo $rows['P_id']; ?>" />
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Project Domain Name</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="p_domain" id="p_domain" value="<?php if($rows['Domain']!=''){ echo stripslashes($rows['Domain']); }?>">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Project Name</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="p_name" id="p_name" value="<?php if($rows['Name']!=''){ echo stripslashes($rows['Name']); }?>">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <select name="p_type" id="p_type">
                            <option><?php if($rows['Type']!=''){ echo stripslashes($rows['Type']); }?></option>
                     ...
                     <!-- <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="p_type" id="p_type" value="<?php if($rows['Type']!=''){ echo stripslashes($rows['Type']); }?>">
                        </div>
                      </div>-->
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <select name="p_category" id="p_category">
                            <option><?php if($rows['Category']!=''){ echo stripslashes($rows['Category']); }?></option>
                       ...
                       <!--<div class="form-group">
                        <label class="col-sm-4 control-label">Project Category</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="p_category" id="p_category" value="<?php if($rows['Category']!=''){ echo stripslashes($rows['Category']); }?>">
                        </div>
                      </div>-->
                      <div class="form-group">
                        <label class="col-sm-4 control-label">File Upload</label>
                        <div class="col-sm-7 controls">
                         <input type="file" name="p_file" id="p_file" value="<?php if($rows['File_Upload']!=''){ echo stripslashes($rows['File_Upload']); }?>">
                        </div>
                      </div>
