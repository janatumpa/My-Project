                   ...
                   $c=1;
                    $rows_per_page=12;
                         if(isset($_REQUEST['page']))
                          ...
                          $res_product=mysql_query("select * from ".TABLE_PREFIX."sent WHERE S_id = '".$_SESSION['userid']."'");
                          $totnumrow=mysql_num_rows($res_product);
                          $totrow=ceil($totnumrow/$rows_per_page);
                            
                            $subCatSql="select * from ".TABLE_PREFIX."sent WHERE S_id = '".$_SESSION['userid']."' limit $offset,$rows_per_page ";
