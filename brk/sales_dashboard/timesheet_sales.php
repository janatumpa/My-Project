              ...
              <div class="col-md-12">
                ...
                ?>-->
                    <a href="View_six.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-eye append-icon"></i> View Six Months List </a> 
                     <a href="addsalestimesheet.php" class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-plus append-icon"></i> Add  Timesheet </a> </div>         
				<h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-table"></i>Timesheet </h3>
                  ...
                  $c = 1;
                 $SqlUser = "SELECT * FROM pro_sales_timesheet WHERE Date > DATE_ADD( CURDATE(), INTERVAL -5 DAY ) and userid = '".$_SESSION['userid']."'";
...
<td><b><a href="edit_timesheet.php?id=<?php echo $FetchRows['id']?>"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></b></a>                                 
							</td>
 </td>
								</tr>
                <?php
