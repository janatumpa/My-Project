...
if($_SESSION['userid'] == "" && $_SESSION['loggedIn'] == ""){
	...
	if(isset($_GET['id']) && $_GET['id'] != "")
    {
		...
		$s_record = mysql_query("select * from pro_sales_timesheet where id='$time_id'");
        $rows = mysql_fetch_array($s_record);

 //print($s_rowsrows);exit();
               ...
               ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input value="<?php echo $FetchRows['Sale_Name']; ?>" name="projectname" id="projectname" readonly="readonly" >
                          </div>
                      </div>-->
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="projectname" id="projectname"  value="<?php if($rows['projectname']!=''){ echo stripslashes($rows['projectname']); }?>" placeholder="Enter ">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="end" id="end"value="<?php if($rows['end']!=''){ echo stripslashes($rows['end']); }?>" placeholder="Ex:10:10 AM">
                          </div>
                      </div>
                      <div class="form-group">
                    ...
                    <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="submit"  value="SUBMIT"><i class="icon-ok"></i> Save</button>
                          ...
                          <a class="btn vd_btn" href="timesheet_sales.php">Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
