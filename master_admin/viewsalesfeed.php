          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="view_feedbackt.php">Developer Feedback List</a> </li>
                <li>View Feedback</li>
              </ul>
            ...
            <table class="table table-striped table-hover" id="data-tables">
                ...
                if(isset($_GET['DF_ID']) && $_GET['DF_ID'] != "")
                {
                  ...
                  //$Client_id = intval($Client_id);
                    $c_record = mysql_query("select * from pro_dev_feedback where user_id='$Client_id'");
...
//$salename = mysql_fetch_array(mysql_query("SELECT * FROM pro_dev_feedback WHERE user_id = '".$FetchRows['D_id']."'"));
               ?>
                  ...
                  <td class="menu-action rounded-btn" width="13%">
                                    	<a href="view_detail.php?C_ID=<?php echo $FetchRows['id']; ?>" class="btn menu-icon vd_bg-green" data-placement="top" data-toggle="tooltip" data-original-title="view">
                                           <i class="fa fa-eye"></i>
                                        </a>                                      
