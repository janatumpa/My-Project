				...
				<h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-bolt mgr-10 profile-icon"></i>Developer</h3>
                  ...
                  <div class="panel-body  table-responsive">
                   ...
                   <select class="span9 chosen"   id="stat<?=$FetchRows['D_id']?>" onChange="changeEmailstatus(this.value,'<?=$FetchRows['D_id']?>')">
									 <option value="Yes" <?php if($FetchRows['EmailVerification'] == 'Yes') {echo 'selected';}?>>Activate</option>
									 <option value="No" <?php if($FetchRows['EmailVerification'] == 'No'){echo 'selected';}?>>De Activate</option>
                   
									 </select>
                  </td>
                     <td>
                    <select class="span9 chosen"  id="stat<?=$FetchRows['D_id']?>" onChange="changestatus(this.value,'<?=$FetchRows['D_id']?>')">
                    <option value="Yes" <?=$FetchRows['DevStatus'] == 'Yes' ? 'selected' : ''?>>Active</option>
                    <option value="No" <?=$FetchRows['DevStatus'] == 'No' ? 'selected' : ''?>>Inactive</option>
                    </select>
                    </td>
...
/********************Status****************/
   ...
   // window.location='status/statusdeveloper.php?stat='+stat+'&id='+id;
		$.post('status/statusdevloper.php',{ stat : stat , id : id });
	}
    
    function changeEmailstatus(stat,id)
	{
   // window.location='status/statusdeveloper.php?stat='+stat+'&id='+id;
		$.post('status/statusEmaildevloper.php',{ stat : stat , id : id });
	}
</script>
<!--end-->
</body>
