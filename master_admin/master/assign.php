              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/assigncode.php" role="form">
                    ...
                    <input type="hidden" name="pid" id="pid" value="<?php echo $rows['P_id']; ?>" />
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                           <input type="text" name="p_name" id="p_name" value="<?php echo $rows['Name']; ?>" readonly="readonly"/>
                          </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Vertical_head name</label>
                        <div class="col-sm-7 controls">
                        <select id="dname" name="dname">
                         <option value="abc">--Select Vertical_head--</option>
                         <?php
                        ...
                        {
                        ?>
                        <option value="<?php echo $FetchRows['D_id']; ?>" <?php if($rows['D_id'] == $FetchRows['D_id']){echo 'selected';}?>><?php echo $FetchRows['Dev_Name']; ?></option>
                         <?php
                        }
                        ?>
                         </select>
                        ...
                        <div class="col-sm-7">
                          <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="submit"  value="SUBMIT"><i class="icon-ok"></i> SUBMIT</button>
