                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="text" name="d_username" id="d_username" value="<?php if($rows['D_Username']!=''){ echo stripslashes($rows['D_Username']); }?>" placeholder="User Name"/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="d_name" id="d_name" value="<?php if($rows['Dev_Name']!=''){ echo stripslashes($rows['Dev_Name']); }?>" placeholder="Name"/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                           <input type="text" name="d_add" id="d_add" value="<?php if($rows['D_address']!=''){ echo stripslashes($rows['D_address']); }?>" placeholder="Address">
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                           <input type="text" name="d_state" id="d_state" value="<?php if($rows['D_State']!=''){ echo stripslashes($rows['D_State']); }?>" placeholder="State">
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="text" name="d_zip" id="d_zip" value="<?php if($rows['D_Zip']!=''){ echo stripslashes($rows['D_Zip']); }?>" placeholder="Zip">
                                </div>
                                <!-- col-xs-9 -->
                              </div>
                              <!-- row --> 
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  ...
                                  <option value="">Register As(choose your Marital Status)</option>
                          ...
                          <!-- form-group -->
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <select class="width-40" id="d_role1" name="d_role1" style="width:60% !important">
                          ...
                          <!-- form-group -->
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <select class="width-40" id="d_designation" name="d_designation" style="width:60% !important">
                                  <option value="">Register As(choose your role)</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                         <input type="text"  name="d_phn" id="d_phn" value="<?php if($rows['Phone_No']!=''){ echo stripslashes($rows['Phone_No']); }?>" placeholder="Phone No" >
                                </div>
                                <!-- col-xs-12 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text"  name="d_li" id="d_li" value="<?php if($rows['D_LI']!=''){ echo stripslashes($rows['D_LI']); }?>" placeholder="LinkedIn">
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                   <input type="text"  name="d_fb" id="d_fb" value="<?php if($rows['D_FB']!=''){ echo stripslashes($rows['D_FB']); }?>" placeholder="Facebook">
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text"  name="d_tw" id="d_tw" value="<?php if($rows['D_TW']!=''){ echo stripslashes($rows['D_TW']); }?>" placeholder="Twitter">
                                </div>
                                <!-- col-xs-9 -->
