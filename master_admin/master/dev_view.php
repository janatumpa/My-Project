                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                          <input type="text" name="s_username" id="s_username" value="<?php echo $rows['D_Username']?>" placeholder="User Name" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="eid" id="eid" value="<?php echo $rows['Developer_id']; ?>" placeholder="Name" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="d_name" id="d_name" value="<?php echo $rows['Dev_Name'];?>" placeholder="Name" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                           <input type="text" name="d_add" id="d_add" value="<?php echo $rows['D_address'];?>" placeholder="Address" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                           <input type="text" name="d_state" id="d_state" value="<?php echo $rows['D_State'];?>" placeholder="State" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="text" name="d_zip" id="d_zip" value="<?php echo $rows['D_Zip'];?>" placeholder="Zip" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                              </div>
                              <!-- row --> 
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="text" name="d_marital" id="d_marital" value="<?php echo $rows['D_Marital'];?>" placeholder="Marital" disabled/>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="role1" id="role1" value="<?php echo $rows['Role'];?>" placeholder="Role" disabled>
                                </div>
                                <!-- col-xs-12 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text" name="Designation" id="Designation" value="<?php echo $rows['designation'];?>" placeholder="Designation" disabled>
                                </div>
                                <!-- col-xs-12 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                         <input type="text"  name="s_phn" id="s_phn" value="<?php echo $rows['Phone_No'];?>" placeholder="Phone No" disabled >
                                </div>
                                <!-- col-xs-12 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text"  name="s_li" id="s_li" value="<?php echo $rows['D_LI'];?>" placeholder="LinkedIn" disabled>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                   <input type="text"  name="s_fb" id="s_fb" value="<?php echo $rows['D_FB'];?>" placeholder="Facebook" disabled>
                                </div>
                                <!-- col-xs-9 -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                 <input type="text"  name="s_tw" id="s_tw" value="<?php echo $rows['D_TW'];?>" placeholder="Twitter" disabled>
                                </div>
                                <!-- col-xs-9 -->
