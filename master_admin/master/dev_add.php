      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_content-section clearfix">
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Developer </h3>
                  </div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/dev_code_add.php" role="form">
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Developer Name</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="name" id="name" placeholder="Enter Developer Name">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Employee Id</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="eid" id="eid" placeholder="Enter Developer Id">
                          </div>
                      </div>
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="phn" id="phn" placeholder="Enter Phone No">
                          </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">ROLE</label>
                        <div class="col-sm-7 controls">
                   	<select name="d_role1" id="d_role"  onChange="myFunction(this.value);"  class="selectborder">
			     	...
			     	<select id="developer" name="d_manager"onChange="myFunctionadd(this.value);" class="selectborder" style="display:none; ">
			...
			<?php
                        ...
                        $SqlUser = "SELECT * FROM  pro_dev_registration WHERE Role='manager' ";
                        ...
                        <option value="<?php echo $FetchRows['D_id']; ?>"><?php echo $FetchRows['Dev_Name']; ?></option>
				       ...
				       <select name="d_vertical" id="manager" style=" display:none; color: #757575; font-size: 1rem;" class="selectborder">
					   <option value="">Select your Vetical head</option>
			           <?php
                        $SqlUser = "SELECT * FROM  pro_dev_registration WHERE Role='vertical_head' ";
                        $ResSqlUser = mysql_query($SqlUser);
                        while($FetchRows = mysql_fetch_array($ResSqlUser))
                         {
                        ?>
