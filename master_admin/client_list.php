...
include "lib/sidebar.php";
 ?>
  ...
  <ul class="nav nav-tabs widget">
    ...
    <li class="active"> <a data-toggle="tab" href="#projects-tab"> Client <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>   
...
<!--                             <th>Nature of Business</th>-->
              ...
              <?php
                 $c = 1;
                 $SqlUser = "SELECT * FROM ".TABLE_PREFIX."customer";
                 $ResSqlUser = mysql_query($SqlUser);
                 while($FetchRows = mysql_fetch_array($ResSqlUser))
                 {
			$salename = mysql_fetch_array(mysql_query("SELECT * FROM pro_sale_registration WHERE S_id = '".$FetchRows['S_id']."'"));
               ?>
								<tr>
                  <td><?php echo $c ?></td>              	
									<td><?php echo $FetchRows['Name']; ?></td>                    
                  <!--<td> <?php echo $FetchRows['Company']; ?></td>   
                                                   -->
									<td><?php echo $salename['Sale_Name']; ?></td>
									<td><?php echo $FetchRows['Phone']; ?></td>  
                  ...
                  <td>
                   <select class="span9 chosen"  id="stat<?=$FetchRows['C_id']?>" onChange="changestatus(this.value,'<?=$FetchRows['C_id']?>')">
									...
									<td class="menu-action rounded-btn" width="13%">
                                    	<a href="view_client.php?C_ID=<?php echo $FetchRows['C_id']; ?>" class="btn menu-icon vd_bg-green" data-placement="top" data-toggle="tooltip" data-original-title="view">
                                           <i class="fa fa-eye"></i>
                                        </a>                                      
                                    	<a href="edit_client.php?C_ID=<?php echo $FetchRows['C_id']; ?>"class="btn menu-icon vd_bg-yellow" data-placement="top" data-toggle="tooltip" data-original-title="edit">
