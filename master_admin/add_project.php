...
$SqlUser = "SELECT * FROM pro_admin_details";
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="<?=$_SERVER['PHP_SELF']?>" role="form" enctype="multipart/form-data">
                        ...
                        <label class="col-sm-4 control-label">Assign By</label>
                        <div class="col-sm-7 controls">
                          <select name="admin" id="admin">
                            <option value="">-- Assign By --</option>
                    <?php 
                              $sql = mysql_query("SELECT * FROM pro_admin_details");
                              while($assign=mysql_fetch_array($sql)){?>
                              <option value="<?=$assign['A_id']?>"><?=$assign['Name']?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="p_name" id="p_name" placeholder="Enter Project Name">
                          </div>
                      </div>
                      <div class="form-group">
                        ...
                        <select id="c_name" name="c_name" onchange="this.form.submit()">
                         <option value="">--Select Client--</option>
                         <?php
                        $SqlUser = "SELECT * FROM pro_customer WHERE CusStatus='Yes'";
                        $ResSqlUser = mysql_query($SqlUser);
                      ...
                      <div class="form-group form-actions">
                        ...
                        <div class="col-sm-7">
                          <button class="btn vd_btn vd_bg-green vd_white" type="submit" name="submit"  value="SUBMIT"><i class="icon-ok"></i> Save</button>
                           ...
                           <a class="btn vd_btn" href="pro_list.php">Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
