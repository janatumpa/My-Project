                    ...
                    <form class="form-horizontal" role="form" action="Code/mail_code.php">
                          ...
                          <div class="form-group clearfix" style="height: 250px; overflow-y:scroll;">
                              <div class="col-md-12">
                                 <?php
                                 $c=1;
                                    $SqlUser = "SELECT Dev_Name as name,Email_Id as email, Designation as deg FROM pro_dev_registration union SELECT Sale_Name as name,EmailId as email, Position as deg FROM pro_sale_registration";
