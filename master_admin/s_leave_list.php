                      ...
                      <?php
                        $rows_per_page=12;
                         if(isset($_REQUEST['page']))
                          ...
                          $sleave="SELECT S_id from pro_sale_registration WHERE Role='Manager'";
                          $res_product=mysql_query($sleave);
                          $totnumrow=mysql_num_rows($res_product);
                          $totrow=ceil($totnumrow/$rows_per_page);
                            
                            $subCatSql="SELECT * from pro_sale_registration limit $offset,$rows_per_page ";
                          $ResSqlUser=mysql_query($subCatSql) or mysql_error();
                          
                     
                 $c = 1;
                 $SqlUser = "SELECT * FROM pro_sale_leaveapp WHERE userid IN($sleave)";
...
<script>
	...
	{
		$.post('status/status_s_leave.php',{ stat : stat , id : id });
	}
</script>
