              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-bar-chart-o"></i> </span>Cient </h3>
                  </div>
                  <div class="panel-body">
                    <form method="post" class="form-horizontal" action="Code/client_code_add.php" role="form">
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Cient Name</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_name" id="c_name" placeholder="Enter Company Name">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_location" id="c_location" placeholder="Enter Location">
                          </div>
                      </div>
                       <div class="form-group">
                        <label class="col-sm-4 control-label">Phone No</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_phn" id="c_phn" placeholder="Enter Phone No">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Email Address</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_email" id="c_email" placeholder="Enter Email Address">
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Nature of Business</label>
                        <div class="col-sm-7 controls">
                          <input type="text" name="c_business" id="c_business" placeholder="Enter Nature of Business">
                          </div>
                      </div>
